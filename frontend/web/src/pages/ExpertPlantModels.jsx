							...
							<div className="card">
									...
									<div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
										<div className="card-title">
											...
											<div className="tab-switcher" style={{ marginLeft: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
												<button className="btn btn-primary" onClick={() => { setShowModal(true) }}>Tạo</button>
											...
											{showModal && (
												<div className="modal-overlay">
													<div className="modal-content">
														<h3 style={{ marginBottom: 12 }}>{editingId ? 'Sửa mô hình' : 'Tạo mô hình mới'}</h3>
														<form onSubmit={handleSave} className="form-grid">
															...
															<div className="cta-row" style={{ justifyContent: 'flex-end' }}>
																<button className="btn btn-secondary" type="button" onClick={() => { setShowModal(false); setForm(emptyForm); setEditingId(null); }}>Hủy</button>
																<button className="btn btn-secondary" type="button" onClick={handleSuggest}>Gợi ý</button>
