      ...
      <div className="container-fluid">
        ...
        <div className="row g-3">
          <div className="col-md-3">
            <div className="card shadow-sm">
              <div className="card-body">
                ...
                <p className="text-muted">Total diseases</p>
                <a className="btn btn-sm btn-primary" href="/admin/diseases">Manage</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-3">
            <div className="card shadow-sm">
              <div className="card-body">
                ...
                <a className="btn btn-sm btn-primary" href="/admin/disease-categories">Manage</a>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-3">
            <div className="card shadow-sm">
              <div className="card-body">
                <h6 className="card-title">Guides</h6>
                <h2 className="card-text">{loading ? "..." : counts.guides}</h2>
                <p className="text-muted">How-to guides</p>
                <a className="btn btn-sm btn-primary" href="/admin/guides">Manage</a>
              </div>
            </div>
          </div>
